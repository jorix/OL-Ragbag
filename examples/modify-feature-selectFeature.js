...
var controls = {
    ...
    modify: new OpenLayers.Control.ModifyFeature(null, {
        selectOnUp: true // To use same event as SelectFeature to select.
    })
};
...
// Create a selectFeture control.
var selLayers = [bottomLayer, middleLayer, topLayer];
...
for (var i = 0, len = selLayers.length; i < len; i++) {
    selLayers[i].events.on(selListener);
}
